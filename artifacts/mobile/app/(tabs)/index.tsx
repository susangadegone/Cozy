        ...
        ListHeaderComponent={
          <View>
            ...
            <View
              style={[
                styles.progressCard,
                { backgroundColor: colors.surface, borderColor: colors.cardBorder, shadowColor: colors.shadow },
              ]}
            >
              <View style={styles.progressTop}>
                ...
                <View style={[styles.progressBadge, { backgroundColor: colors.tintLight }]}>
              ...
              <View style={[styles.barBg, { backgroundColor: colors.surfaceSecondary }]}>
                <View
                  style={[
                    styles.barFill,
                    {
                      backgroundColor: progressPct === 1 ? colors.success : colors.tint,
